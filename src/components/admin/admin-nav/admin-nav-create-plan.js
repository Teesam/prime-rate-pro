        ...
        <div className = 'Dashboard-nav'>
            <div>
                ...
                <ul id = 'dashboard-ul'>
                    ...
                    <li onClick = { () => history.push('/admin/createinvestment')} id = 'dash-active'>
                        <i id = 'dash-active-icon' className = 'fas fa-plus'></i>
                        <button id = 'dash-active-button' className = 'Dash-nav-button'>Create Investment</button>
                    </li>
